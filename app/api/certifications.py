...
@router.post('/certifications', dependencies=[Depends(require_role("admin"))], response_model=CertificationSchema)
...
@router.put('/certifications/{certification_id}', dependencies=[Depends(require_role("admin"))], response_model=CertificationSchema)
