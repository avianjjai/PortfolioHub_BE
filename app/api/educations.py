...
# create education
@router.post('', dependencies=[Depends(require_role("admin"))], response_model=Education)
...
# update education
@router.put('/{education_id}', dependencies=[Depends(require_role("admin"))], response_model=Education)
...
# delete education
@router.delete('/{education_id}', dependencies=[Depends(require_role("admin"))], response_model=dict)
